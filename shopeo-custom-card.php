...
use Shopeo\ShopeoCustomCard\Admin;
...
add_action( 'wp_enqueue_scripts', function () {
	...
	wp_enqueue_script( 'shopeo-custom-card-frontend-script', plugins_url( '/assets/js/frontend.js', SHOPEO_CUSTOM_CARD_PLUGIN_FILE ), array(), '0.0.163', true );
